...
object ComCodeGroupTable : IdTable<String>("com_code_group") {
    ...
    val codeGroupName: Column<String> = varchar("code_group_name", 100).uniqueIndex()
    val parentCodeGroupId: Column<String?> = (varchar("parent_code_group_id", 4) references codeGroupId).nullable().default(null)
